...
Blockly.Blocks["machine.I2C_I2C.readfrom_mem"] = {
  init: function() {
    this.appendValueInput("I2C_ID")
        .setCheck("Number")
        .appendField(" I2C.readfrom_mem ID");
...
Blockly.Blocks["machine.I2C_I2C.readfrom_mem_into"] = {
  init: function() {
    this.appendValueInput("I2C_ID")
        .setCheck("Number")
        .appendField(" I2C.readfrom_mem_into ID");
...
Blockly.Blocks["machine.I2C_I2C.writeto_mem"] = {
  init: function() {
    this.appendValueInput("I2C_ID")
        .setCheck("Number")
        .appendField(" I2C.writeto_mem ID");
...
Blockly.Blocks['gps_get_countsat'] = {
  init: function() {
    this.setColour(135);
    this.appendDummyInput()
        .appendField("GPS Satellite count");
...
Blockly.Blocks['gps_get_satellites_used'] = {
  init: function() {
    this.setColour(135);
    this.appendDummyInput()
        .appendField("GPS Satellite used");
...
Blockly.Blocks["esp32_sgp30_init"] = {
  init: function() {
    this.appendDummyInput()
        .appendField("SGP30 Init");
    this.appendValueInput("SGP30_ADDRESS")
        .setCheck("Number")
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("address");
    this.appendValueInput("I2C_ID")
    ...
    this.setColour(0);
    this.setTooltip("");
    this.setHelpUrl("https://github.com/alexmrqt/micropython-sgp30");
  }
};

Blockly.Blocks["esp32_sgp30_read_co2"] = {
  init: function() {
    this.appendValueInput("SGP30_ADDRESS")
        .setCheck("Number")
        .appendField(" SGP30 CO2 address");
    this.setColour(0);
    this.setOutput(true, null);
    this.setTooltip(".. method:: read co2 from SGP30");
    this.setHelpUrl("https://github.com/alexmrqt/micropython-sgp30");
  }
};

Blockly.Blocks["esp32_sgp30_read_tvoc"] = {
  init: function() {
    this.appendValueInput("SGP30_ADDRESS")
        .setCheck("Number")
        .appendField(" SGP30 TVOC address");
    this.setColour(0);
    this.setOutput(true, null);
    this.setTooltip(".. method:: read tvoc from SGP30");
    this.setHelpUrl("https://github.com/alexmrqt/micropython-sgp30");
  }
};
...
Blockly.Blocks["esp32_bme680_init"] = {
  init: function() {
    this.appendDummyInput()
        .appendField("BME 680 Init");
    this.appendValueInput("BME_680_ADDRESS")
        .setCheck("Number")
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("address");
    this.appendValueInput("I2C_ID")
    ...
    this.setColour(0);
    this.setTooltip("");
    this.setHelpUrl("https://github.com/robert-hh/BME680-Micropython");
  }
};

Blockly.Blocks["esp32_bme680_read_humidity"] = {
  init: function() {
    this.appendValueInput("BME_680_ADDRESS")
        .setCheck("Number")
        .appendField(" BME Humidity address");
    this.setColour(0);
    this.setOutput(true, null);
    this.setTooltip(".. method:: read humidity from BME680");
    this.setHelpUrl("https://github.com/robert-hh/BME680-Micropython");
  }
};

Blockly.Blocks["esp32_bme680_read_pressure"] = {
  init: function() {
    this.appendValueInput("BME_680_ADDRESS")
        .setCheck("Number")
        .appendField(" BME Pressure  address");
    this.setColour(0);
    this.setOutput(true, null);
    this.setTooltip(".. method:: read pressure from BME680");
    this.setHelpUrl("https://github.com/robert-hh/BME680-Micropython");
  }
};

Blockly.Blocks["esp32_bme680_read_gas"] = {
  init: function() {
    this.appendValueInput("BME_680_ADDRESS")
        .setCheck("Number")
        .appendField(" BME Gas address");
    this.setColour(0);
    this.setOutput(true, null);
    this.setTooltip(".. method:: read gas value from BME680");
    this.setHelpUrl("https://github.com/robert-hh/BME680-Micropython");
  }
};

Blockly.Blocks["esp32_bme680_read_temperature"] = {
  init: function() {
    this.appendValueInput("BME_680_ADDRESS")
        .setCheck("Number")
        .appendField(" BME Temperature address");
    this.setColour(0);
    this.setOutput(true, null);
    this.setTooltip(".. method:: read temperature from BME680");
    this.setHelpUrl("https://github.com/robert-hh/BME680-Micropython");
  }
};
